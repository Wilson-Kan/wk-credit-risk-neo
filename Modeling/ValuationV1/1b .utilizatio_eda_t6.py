...
pyspark_df = spark.sql(
  """
    SELECT
      a.*,
      b.avg_bal as avg_bal6,
      b.max_bal as max_bal6,
      b.mthend_bal as mthend_bal6,
      b.creditLimit as creditLimit6,
      b.monthOnBook as MOBp6,
      6 as t_forward
    FROM
      ...
      and a.referenceDate = dateadd(month, -6, b.referenceDate)
  """
)
...
final_out.toPandas().to_csv(
    "/Workspace/Users/wilson.kan@neofinancial.com/ValuationV1/for_eda_t6.csv"
)

# COMMAND ----------

plot_me = pd.read_csv("/Workspace/Users/wilson.kan@neofinancial.com/ValuationV1/for_eda_t6.csv")
