...
pyspark_df = spark.sql(
  """
    SELECT
      a.*,
      b.avg_bal as avg_bal12,
      b.max_bal as max_bal12,
      b.mthend_bal as mthend_bal12,
      b.creditLimit as creditLimit12,
      b.monthOnBook as MOBp12,
      12 as t_forward
    FROM
      neo_views_credit_risk.wk_utilization_v1_data as a
      inner join neo_views_credit_risk.wk_utilization_v1_data as b on a.accountId = b.accountId
      and a.referenceDate = dateadd(month, -12, b.referenceDate)
  """
)
...
final_out.toPandas().to_csv(
    "/Workspace/Users/wilson.kan@neofinancial.com/ValuationV1/for_eda_t12.csv"
)

# COMMAND ----------

plot_me = pd.read_csv("/Workspace/Users/wilson.kan@neofinancial.com/ValuationV1/for_eda_t12.csv")
